...
public class Homework extends Schedule implements Serializable {
    ...
    private static final Hashtable<Integer, String> homeworkLectureIDTable = new Hashtable<>();
    ...
    public static String getHomeworkLectureName(int lectureID) {
        if (homeworkLectureIDTable.containsKey(lectureID)) {
            return homeworkLectureIDTable.get(lectureID);
        }

        return Constant.EMPTY_STRING;
    }

    public static boolean putHomeworkLectureName(int lectureID, String lectureName) {
        if (homeworkLectureIDTable.containsKey(lectureID)) {
            return false;
        }

        homeworkLectureIDTable.put(lectureID, lectureName);
        return true;
    }
