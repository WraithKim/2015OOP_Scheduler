...
public class NetworkTestMain {
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------------------------------------------------------------");
        System.out.println(HttpRequest.sendHttpPostRequest("http://cautis.cau.ac.kr/LMS/LMS/prof/myp/pLmsMyp040/getStudLectureCourse.do", factory.getHomeworkRequestPayload(20146824), "iso-8859-1"));
    }
}
